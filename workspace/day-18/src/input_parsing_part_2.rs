...
mod tests {
    ...
    fn example_0() {
        ...
        assert_eq!(expressions[0].evaluate(), 51);
    }
    ...
    fn example_1() {
        let content = "1 + 2 * 3 + 4 * 5 + 6".to_string();
        let expressions = parse_string(content);
        assert_eq!(expressions[0].evaluate(), 231);
    }
    ...
    fn example_2() {
        ...
        let expressions = parse_string(content);
        assert_eq!(expressions[0].evaluate(), 46);
    }
    ...
    fn example_3() {
        ...
        let expressions = parse_string(content);
        assert_eq!(expressions[0].evaluate(), 1445);
    }
    ...
    fn example_4() {
        ...
        let expressions = parse_string(content);
        assert_eq!(expressions[0].evaluate(), 669060);
    }
    ...
    fn example_5() {
        ...
        expressions[0].print(0);

        assert_eq!(expressions[0].evaluate(), 23340);
    }
}
